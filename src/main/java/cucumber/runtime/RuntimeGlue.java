...
public class RuntimeGlue implements Glue {
    ...
    @Override
    public void addBeforeHook(@SuppressWarnings("rawtypes") HookDefinition hookDefinition) {
        addBeforeHook(hookDefinition, HookScope.SCENARIO);
    }

    @Override
    public void addAfterHook(@SuppressWarnings("rawtypes") HookDefinition hookDefinition) {
    ...
    @Override
    public void addBeforeHook(@SuppressWarnings("rawtypes") HookDefinition hookDefinition, HookScope scope) {
        switch (scope) {
            case STEP:
    ...
    @Override
    public void addAfterHook(@SuppressWarnings("rawtypes") HookDefinition hookDefinition, HookScope scope) {
        switch (scope) {
            case STEP:
